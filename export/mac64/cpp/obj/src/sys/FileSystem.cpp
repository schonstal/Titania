...
{
		HX_STACK_FRAME("sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",69,0x65d3e0d3)
			...
			while((true)){
				...
				struct _Function_3_1{
					inline static bool Block( ::String &part){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",74,0x65d3e0d3)
						{
							HX_STACK_LINE(74)
...
{
		HX_STACK_FRAME("sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","/usr/lib/haxe/std/cpp/_std/sys/FileSystem.hx",79,0x65d3e0d3)
		HX_STACK_ARG(path,"path")
		HX_STACK_LINE(80)
